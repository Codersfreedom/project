...
<body>
  ...
  <ul class="nav nav-tabs d-flex ">
    ...
    <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle" id="navbarDropdown" data-toggle="dropdown" href="/partials/_nav.php" role="button"
    ...
    <li class="nav-item">
      <a class="nav-link" href="admin.php">Check Status</a>
    </li>
    <li class="nav-item">
