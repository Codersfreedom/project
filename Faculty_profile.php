                            ...
                            <div class="col-sm-6 mb-3">
                                <div class="card h-100">
                                    <div class="card-body">
                                        ...
                                        echo ' <h6 class="d-flex align-items-center mb-3"><i
                                                class="material-icons text-info mr-2"></i>Workload Status</h6>
                                        <span>Total Subjects Assigned ' . $subCount . '</span>  
                                        <div class="progress mb-3" style="height: 5px">
                                      
                                            <div class="progress-bar bg-primary" role="progressbar" style="width: ' . ($subCount * 100) / $totalSub .'%"
                                                aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <span>Total Year Assigned ' . $yearCount . '</span>
                                        <div class="progress mb-3" style="height: 5px">
                                            <div class="progress-bar bg-primary" role="progressbar" style="width: '.( $yearCount *100 )/4 .'%"
                                                aria-valuenow="72" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <span>Total Labs ' . $labCount . '</span>
                                        <div class="progress mb-3" style="height: 5px">
                                            <div class="progress-bar bg-primary" role="progressbar" style="width: 89%"
                                                aria-valuenow="89" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <span>Total Theory ' . $theoryCount . '</span>
                                        <div class="progress mb-3" style="height: 5px">
                                            <div class="progress-bar bg-primary" role="progressbar" style="width: 55%"
                                                aria-valuenow="55" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <span>Total Workload ' .(26- $totalWL['totalWL']) . '</span>
                                        <div class="progress mb-3" style="height: 5px">
