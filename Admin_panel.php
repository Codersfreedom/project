    ...
    <div class="page-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <a href="teacher.php">  <div class="card card-hover">
          ...
          <!-- Column -->
          <div class="col-md-6 col-lg-2 col-xlg-3">
          <a href="subject.php">  <div class="card card-hover">
          ...
          <!-- Column -->
          <div class="col-md-6 col-lg-2 col-xlg-3">
          <a href="room.php">  <div class="card card-hover">
          ...
          <!-- Column -->
          <div class="col-md-6 col-lg-2 col-xlg-3">
          <a href="Allot_room.php">  <div class="card card-hover">
              <div class="box bg-info text-center">
                <h1 class="font-light text-white">
                  <i class="mdi mdi-arrow-all"></i>
                </h1>
                <h6 class="text-white">Allot Rooms</h6>
              </div>
            </div></a>
          </div>
          <!-- Column -->
          ...
          <!-- Column -->
          <div class="col-md-6 col-lg-2 col-xlg-3">
          <a href="theory.php">  <div class="card card-hover">
              <div class="box bg-cyan text-center">
                <h1 class="font-light text-white">
          ...
          <!-- Column -->
          <div class="col-md-6 col-lg-2 col-xlg-3">
          <a href="admin.php"> <div class="card card-hover">
