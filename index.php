...
<body>
  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img class="d-block w-100" style="width:2400px; height: 600px; " src="assets/img/Nitmas_banner.jpg"
          alt="First slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" style="width:2400px; height: 600px; " src="assets/img/Banner2.jpg"
          alt="Second slide">
      </div>
      <div class="carousel-item">
      ...
      <div class="carousel-item">
        <img class="d-block w-100" style="width:2400px; height: 600px; " src="assets/img/language_Laboratory.jpg"
          alt="Third slide">
      </div>
    </div>
  ...
  <!-- Faculty section -->
  <h2 class="text-center my-3">Our Faculty</h2>
  <hr>
  <div class="container d-flex flex-wrap justify-content-between my-3">

    <div class="card" style="width: 18rem;">
      <img class="card-img-top" src="assets\img\faculty\Principal.png" alt="Card image cap">
      <div class="card-body">
        <h5 class="card-title">Prof. Sujoy Biswas</h5>
        <h6>Principal</h6>
    ...
    <div class="card" style="width: 18rem;">
      <img class="card-img-top" style="width:286.4px; height: 286.4px; " src="assets\img\faculty\SS.jpg"
        alt="Card image cap">
      <div class="card-body">
        <h5 class="card-title">Prof. Sunanda Sinha</h5>
    ...
    <div class="card" style="width: 18rem;">
      <img class="card-img-top " style="width:286.4px; height: 286.4px; " src="assets\img\faculty\SB.jpg"
        alt="Card image cap">
      <div class="card-body">
        <h5 class="card-title">Prof. Souvik Biswas</h5>
        <h6>Assistant Professor</h6>
    ...
    <!-- <div class="card" style="width: 18rem;">
  <img class="card-img-top" style="width:286.4px; height: 286.4px; " src="assets\img\faculty\DSD.jpg" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">Prof. Deep Suman Dev</h5>
    <h6>Assistant Professor</h6>
    <p class="card-text">Database Management System, Cryptography & Network Security, Internet Technology, Microprocessor and Microcontrollers, E-Commerce, Computer Graphics, Numerical Methods, Computer Organization, Introduction to Computing.</p>
    <a href="#" class="btn btn-primary">Learn more</a>
  </div>
</div> -->
    ...
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <div>
                ...
                <h4> Jhinga, Diamond Harbour Road</h4>
                <h4>P.O. Amira, South 24 Parganas</h4>
                <h4><strong>Tell:</strong>03174 -245078/101</h4>
                <h4><strong>Email: </strong> info@nitmas.edu.in</h4>
            </div>
  ...
  <footer class="text-center text-lg-start text-white" style="background-color: #929fba">
      ...
      <section class="">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
            ...
            <p>
              This Website provides a better way of generating routine for a
              university with a optimize and dynamic way.
            </p>
          </div>
          <!-- Grid column -->
          ...
          <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
            ...
            <p>
              <a class="text-white">Manage Faculty</a>
            </p>
            <p>
              <a class="text-white">Manage Subjects</a>
            </p>
            <p>
              <a class="text-white">Check Status</a>
            </p>
            <p>
              <a class="text-white">Generate Routine</a>
            </p>
          </div>
          <!-- Grid column -->
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
      © 2023 Copyright:
      <a class="text-white" href="#">Routine Generator</a>
    </div>
    <!-- Copyright -->
  </footer>
  <!-- Footer -->
